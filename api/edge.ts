...
export default async function handler(request: VercelRequest, response: VercelResponse) {
  const userAgent = request.headers['user-agent']
    // workspaces/SDfdhsjfkjfslkd?name=123&age=126dshfk
    ...
    .send(/* html */ `
      ...
      <html lang="en">
        <head>
          ...
          <meta property="og:url" content="https://notion-vite-vue3-9j89a2gri-hwa-j.vercel.app/workspaces/${id}" />
          <meta property="twitter:card" content="summary" />
          <meta property="twitter:site" content="Notion Clone!" />
          <meta property="twitter:title" content="${title}" />
          <meta property="twitter:description" content="${content}" />
          <meta property="twitter:image" content="${poster}" />
          <meta property="twitter:url" content="https://notion-vite-vue3-9j89a2gri-hwa-j.vercel.app/workspaces/${id}" />
